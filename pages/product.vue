<template>
    <div>
        <div class="z-50 nav_bar w-screen h-5 bg-white fixed flex justify-between items-center pl-1 pr-1 transition duration-150"
            :class="barOpacity"
        >
        ...
        <div @scroll="handleScroll" class="product_wrap">
            <Swiper>
                <SwiperSlide>
                    <van-image height="9rem" fit="cover" src="https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=1870521716,857441283&fm=26&gp=0.jpg" alt="" />
                </SwiperSlide>
                <SwiperSlide>
                    <van-image height="9rem" fit="cover" src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1542609117,2286902976&fm=26&gp=0.jpg" alt="" />
                </SwiperSlide>
                <SwiperSlide>
                    <van-image height="9rem" fit="cover" src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1731472669,4215674773&fm=26&gp=0.jpg" alt="" />
                </SwiperSlide>
                <div class="swiper-pagination" slot="pagination"></div>
            </Swiper>
            <div class="product_message p-2 bg-white">
                <div class="price text-red-600 text-base font-semibold">￥<span class="text-2xl">116</span>.00</div>
                <div class="product_title text-lg font-semibold">网易严选 天然食品级豆腐猫砂快速结团宠物猫咪用品 绿茶味 2.6kg*4包整箱装</div>
            </div>
            ...
            <div class="product_store bg-white rounded mt-2 mb-2 p-2">
                <div class="store_name flex items-center">
                    <div class="w-4 h-4 rounded-sm bg-white overflow-hidden">
                        <van-image fit="cover" width="100%" height="100%" src="https://img01.yzcdn.cn/vant/cat.jpeg" />
                    </div>
                ...
                <div class="flex justify-around">
                    <van-button plain round size="small" icon="star-o">关注店铺</van-button>
                    <van-button plain round size="small" icon="shop-o">进入店铺</van-button>
                </div>
            </div>
            ...
            <div class="product_detail bg-white rounded mt-2">
                <van-tabs v-model="activeName">
                    <van-tab title="商品介绍" name="a">
                        <van-image src="https://cdnimg.chinagoods.com/jpg/2020/07/31/a59bca31b32e0ac451e207f744deb274.jpg" />
                        <van-image src="https://cdnimg.chinagoods.com/jpg/2020/07/31/a59bca31b32e0ac451e207f744deb274.jpg" />
                        <van-image src="https://cdnimg.chinagoods.com/jpg/2020/07/31/a59bca31b32e0ac451e207f744deb274.jpg" />
                        <van-image src="https://cdnimg.chinagoods.com/jpg/2020/07/31/a59bca31b32e0ac451e207f744deb274.jpg" />
                    </van-tab>
